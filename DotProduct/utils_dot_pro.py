...
MID = int(np.ceil(float(N_Cell)/2))
...
def K_nearest_Dot_product(X,Y):
#X is the train Data and Y is the query data for which we need to find K similar patches
# using the indexing for inner product to rank the nearest patches.
...
# returns inner product of p1 and p2
